...
| Fingerprint Reader | 🫆 Synaptics WBDI-SGX                  | ❌ Not supported on macOS, and uses the "Intel Software Guard Extensions Device" module that has been disabled in the BIOS|
