...
| Fingerprint Reader | 🫆 Synaptics WBDI-SGX                  | ❌ Not supported on macOS, and uses the "Intel Software Guard Extensions Device" hardware technology that has been disabled in the BIOS|
